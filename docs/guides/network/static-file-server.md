...
For further instructions on how to add external dependencies to Web Components, read [avoiding loading the same files multiple times](../web-apps/introduction-to-web-components.md#avoiding-loading-the-same-files-multiple-times) on the Web Components page.
