...
Starcounter 3.0.0 Release is available for general access.

Downloads:

* [`Starcounter.3.0.0.zip`](https://starcounter.io/Starcounter/Starcounter.3.0.0.zip) archive with all required NuGet packages.
* [`star-3.0.0.zip`](https://starcounter.io/Starcounter/star-3.0.0.zip) Starcounter command line `star` tool for Windows.
* [`star-3.0.0.tar.gz`](https://starcounter.io/Starcounter/star-3.0.0.tar.gz) Starcounter command line `star` tool for Linux.
...
## Starcounter 3.0.0 release main changes
...
* Create a folder for Starcounter binaries, for example `Starcounter.3.0.0`.
* Download [`Starcounter.3.0.0.zip`](https://starcounter.io/Starcounter/Starcounter.3.0.0.zip) into the folder.
...
![](.gitbook/assets/zip-archive-unblock%20%281%29.png)
...
```text
cd $HOME
mkdir Starcounter.3.0.0
cd Starcounter.3.0.0
wget https://starcounter.io/Starcounter/Starcounter.3.0.0.zip
unzip Starcounter.3.0.0.zip
```
...
<configuration>
  <packageSources>
    <clear />
    <add key="local" value="[Starcounter.3.0.0]" />
...
**Note**: Replace the `[Starcounter.3.0.0]` value with the actual path to the folder with unzipped Starcounter binaries.
