...
To get many more examples of how interactivity is handled, take a look at the [UniformDocs repo](https://github.com/Starcounter/UniformDocs) where the most common UI patterns are demonstrated.
