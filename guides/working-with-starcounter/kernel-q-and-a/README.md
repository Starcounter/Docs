...
A description of logging and anwers to questions like "what is log and logopt?", "when and how are logs converted into logopt?", and "what is the way to tweak the parameters of logging?" can be found on the [Log Retention page](/guides/working-with-starcounter/log-retention/). 
...
No, it is generally not safe to do backups on active databases unless certain procedures are followed. These procedures and more can be found in [Making Database Backups](https://starcounter.io/guides/tools/run-starcounter-in-production/#making-database-backups). 
