...
No, it is generally not safe to do backups on active databases unless certain procedures are followed. These procedures and more can be found in [Making Database Backups](/guides/working-with-starcounter/run-starcounter-in-production/#making-database-backups). 
