...
1. [JSON-by-example](http://starcounter.io/guides/json/json-by-example/) (in JSON file) - this is the preferred way
...
Properties of the view-model have to be bound to (in dynamic JSON) Common Language Runtime or (in static JSON) code-behind file. In <a href="http://starcounter.io/guides/json/json-data-binding/#specify-datatype">JSON data binding</a> we explain data bindings in-depth, and how to avoid manual value transfer into the view-model.
...
<a href="http://starcounter.io/guides/json/json-data-binding/#specify-datatype">There are two ways of doing that:</a>
<ul>
